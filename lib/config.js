...
// Deferred / scheduled command sets that haven't launched yet live here as
// <id>.json. Kept out of LOG_DIR's top level so the run-history loader (which
// scans LOG_DIR for *.json) never mistakes a pending task for a finished run.
export const PENDING_DIR = path.resolve(LOG_DIR, '.pending');
